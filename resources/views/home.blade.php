	...
	<div class="header">
		<div class="w3layouts_header_left">
				<div class="top-nav-text">
						<p>Call Us : <span class="call">+62 8578 8867 889</span></p>
						<p>Email Us : <span class="mail"><a href="mailto:info@example.com">gamelead@example.com</a></span></p>
					</div>
		</div>
		...
		<div class="slider">
			<div class="callbacks_container">
				<ul class="rslides" id="slider3">
					...
					<li>
						<div class="slider-img">
							<img src="images/CSGO.jpg" class="img-responsive" alt="Fantasy World">
						</div>
						<div class="slider-info">
					...
					<li>
						<div class="slider-img">
							<img src="images/AOV.jpg" class="img-responsive" alt="Fantasy World">
						</div>
						<div class="slider-info">
